...
export function SearchBar() {
  return (
    <div className="w-full max-w-4xl bg-white rounded-2xl md:rounded-full p-2 md:p-2 flex flex-col md:flex-row shadow-2xl shadow-black/20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="p-1">
        <Button size="lg" className="w-full md:w-auto h-14 md:h-full rounded-xl md:rounded-full md:px-8 text-lg font-bold shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-all duration-300 transform hover:scale-[1.02]">
